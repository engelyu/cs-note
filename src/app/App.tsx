...
function ScenarioNavigation({ algorithm, onSelect }: { algorithm: AlgorithmId; onSelect: (algorithm: AlgorithmId) => void }) {
  ...
  return <div className="scenario-navigation"><div className="sidebar-heading"><span>ALGORITHMS</span><button aria-label="More algorithms">•••</button></div><p className="sidebar-subtitle">Guided algorithm traces</p>
    ...
    <div className="sidebar-divider" /><div className="sidebar-section-label">SESSION</div><div className="session-card"><span className="session-dot" /><span><strong>{imported ? "Imported replay" : "Verified replay"}</strong><small>{imported ? "Algorithm Visualizer commands" : "semantic artifact · v1"}</small></span></div>
  ...
  return <Workbench
    ...
    editor={
      <div className="editor-shell">
        <div className="editor-header"><div><span className="eyebrow">NOW REPLAYING</span><h1>Tarjan's Strongly Connected Components</h1></div><div className="editor-actions"><button className="action-button">↗ <span>Open lesson</span></button></div></div>
...
function LisWorkbench({ onSelect }: { onSelect: (algorithm: AlgorithmId) => void }) {
  ...
  return <Workbench
    ...
    editor={
      <div className="editor-shell">
        <div className="editor-header"><div><span className="eyebrow">NOW REPLAYING</span><h1>Longest Increasing Subsequence</h1></div><div className="editor-actions"><button className="action-button">↗ <span>Open lesson</span></button></div></div>
        <section className="canvas-frame" aria-label="Algorithm canvas">
