...
8. The package capability declaration enables view toggling and Canvas Layout editing while disabling input editing and rerunning for the curated Tarjan Scenario. The Student Runtime must honor those capabilities rather than infer permissions from the presence of a view.
